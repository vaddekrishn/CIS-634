...
public class AdminResetpassActivity extends AppCompatActivity {
    ...
    private void InsertUser() {
        String URL = "http://ims.ditests.com/api/admin/resetPassword";

        JSONObject jobj = new JSONObject();

        try {
            jobj.put("admin_id", user_ID);
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST,
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    //    Toast.makeText(AdminResetpassActivity.this, response.toString(), Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            if (login_sts.equals("true")) {
                                ...
                                Toast.makeText(AdminResetpassActivity.this, "Password Change successfully !", Toast.LENGTH_SHORT).show();

                                Intent intent = new Intent(AdminResetpassActivity.this, AdminLoginActivity.class);
                                ...
                                Toast.makeText(AdminResetpassActivity.this, "User not registered!", Toast.LENGTH_SHORT).show();
                            }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                     //   Toast.makeText(AdminResetpassActivity.this, "Something Went Wrong", Toast.LENGTH_SHORT).show();
                    }
                });
