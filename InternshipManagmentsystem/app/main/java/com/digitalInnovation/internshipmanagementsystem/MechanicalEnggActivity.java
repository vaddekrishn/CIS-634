...
public class MechanicalEnggActivity extends AppCompatActivity {
    RecyclerView recMech;
    List<MechPogo> mechPogoList;
   ...
   // String URL="http://ims.ditests.com/api/get_all_internship";
    ...
    String user_id,Internship_Id,jobtype,campustype,branchname,Title,companyName,companyAddress,Description;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recMech=findViewById(R.id.recMech);
        ...
        backbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MechanicalEnggActivity.this,MainActivity.class);
                startActivity(intent);
            }
        });


        recMech.setHasFixedSize(true);
        mechPogoList = new ArrayList<>();
        mechPogoList.clear();
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            //    Toast.makeText(MechanicalEnggActivity.this, "get Internship data", Toast.LENGTH_SHORT).show();
                                ...
                                for (int r=0;r<array.length();r++){
                                   ...
                                   branchname =branchObject.getString("name");
                                    ...
                                    mechPogoList.add(pogo);

                                    LinearLayoutManager linearLayoutManager = new LinearLayoutManager(MechanicalEnggActivity.this);
                                    recMech.setLayoutManager(linearLayoutManager);
                                    mechanicalAdapter = new MechanicalAdapter(mechPogoList,MechanicalEnggActivity.this);
                                    recMech.setAdapter(mechanicalAdapter);

                                }


                            }else{
                                Toast.makeText(MechanicalEnggActivity.this, "Data not retrived", Toast.LENGTH_SHORT).show();
                            }
...
//                         mechanicalAdapter.notifyDataSetChanged();
                ...
                new Response.ErrorListener() {
                    ...
                    //    Toast.makeText(MechanicalEnggActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
        );
        ...
        Volley.newRequestQueue(MechanicalEnggActivity.this).add(request);
    }
}