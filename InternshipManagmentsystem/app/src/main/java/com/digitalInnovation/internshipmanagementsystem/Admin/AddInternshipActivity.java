...
import com.digitalInnovation.internshipmanagementsystem.Adapter.SpinnerAdapter;
...
public class AddInternshipActivity extends AppCompatActivity {
    ...
    String Title,CompanyName,CompanyAddress,CompanyDescription,JobType,CampusType,BranchCategory,typeofJob,typeofCampus,categoryofBranch;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jobTypeSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            //    Toast.makeText(AddInternshipActivity.this, jobtypeIds, Toast.LENGTH_SHORT).show();
            }
        ...
        campusTypespinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            //    Toast.makeText(AddInternshipActivity.this, campustypeIds, Toast.LENGTH_SHORT).show();
            }
        ...
        branchSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
              ...
              //  Toast.makeText(AddInternshipActivity.this, branchIds, Toast.LENGTH_SHORT).show();
            }
        ...
        backbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AddInternshipActivity.this, MainActivity2.class);
    ...
    private void getBranchData() {
        ...
        JsonObjectRequest request = new JsonObjectRequest(
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (login_sts.equals("true")){
                             //   Toast.makeText(AddInternshipActivity.this, "get Branch data", Toast.LENGTH_SHORT).show();
                                ...
                                for (int p=0;p<array.length();p++){
                                    ...
                                    branchtwoAdapter = new ArrayAdapter<>(AddInternshipActivity.this, android.R.layout.simple_spinner_item,
                                            branchPogoList);
                                ...
                                Toast.makeText(AddInternshipActivity.this, "Data not retrived", Toast.LENGTH_SHORT).show();
                            }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                      //  Toast.makeText(AddInternshipActivity.this, "Something Went wrong", Toast.LENGTH_SHORT).show();
                    }
                }
        );
        ...
        Volley.newRequestQueue(AddInternshipActivity.this).add(request);
    }
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (login_sts.equals("true")){
                              //  Toast.makeText(AddInternshipActivity.this, "get Campus data", Toast.LENGTH_SHORT).show();
                                ...
                                for (int m=0;m<array.length();m++){
                                    ...
                                    campustypeAdapter = new ArrayAdapter<>(AddInternshipActivity.this, android.R.layout.simple_spinner_item,
                                            campustypePogoList);
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (login_sts.equals("true")){
                             //   Toast.makeText(AddInternshipActivity.this, "get JobType data", Toast.LENGTH_SHORT).show();
                                ...
                                for (int k=0;k<array.length();k++){
                                    ...
                                    jobtypeAdapter = new ArrayAdapter<>(AddInternshipActivity.this, android.R.layout.simple_spinner_item,
                                            jobtypeList);
    ...
    private void addInternshipData() {
        String URL ="http://Ims.ditests.com/api/admin/add_internship";
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST,
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        Toast.makeText(AddInternshipActivity.this, "data Inserted successfully !", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                     //   Toast.makeText(AddInternshipActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                })
        {
