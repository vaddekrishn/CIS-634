...
public class CivilPogo {

    Integer id;
    String title, company_name, address, description,job_type, campus_type, branch;

    public CivilPogo(Integer id, String title, String company_name, String address, String description, String job_type, String campus_type, String branch) {
        this.id = id;
        this.title = title;
